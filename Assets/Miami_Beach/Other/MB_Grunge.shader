...
Shader "AE/Grunge"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Grunge_Tint;
			float4 _Normal_ST;
			float4 _Metallic_Smoothness_ST;
			...
			sampler2D _Grunge;
			sampler2D _Normal;
			sampler2D _Metallic_Smoothness;
						...
						)
			{
				...
				float4 triplanar3 = TriplanarSampling3( _Grunge, ase_worldPos, normalWS, 1.0, temp_cast_1, 1.0, 0 );
				...
				float3 unpack13 = UnpackNormalScale( tex2D( _Normal, uv_Normal ), _Normal_Scale );
				unpack13.z = lerp( 1, unpack13.z, saturate(_Normal_Scale) );
				
				float2 uv_Metallic_Smoothness = packedInput.ase_texcoord5.xy * _Metallic_Smoothness_ST.xy + _Metallic_Smoothness_ST.zw;
				float4 tex2DNode12 = tex2D( _Metallic_Smoothness, uv_Metallic_Smoothness );
				
				float2 uv_AmbientOcclusion = packedInput.ase_texcoord5.xy * _AmbientOcclusion_ST.xy + _AmbientOcclusion_ST.zw;
				
				surfaceDescription.BaseColor = staticSwitch28.rgb;
				surfaceDescription.Normal = unpack13;
				...
				surfaceDescription.Smoothness = ( _Smoothness * tex2DNode12.a );
				surfaceDescription.Occlusion = tex2D( _AmbientOcclusion, uv_AmbientOcclusion ).r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_Metallic_Smoothness = packedInput.ase_texcoord2.xy * _Metallic_Smoothness_ST.xy + _Metallic_Smoothness_ST.zw;
				float4 tex2DNode12 = tex2D( _Metallic_Smoothness, uv_Metallic_Smoothness );
				
				float2 uv_AmbientOcclusion = packedInput.ase_texcoord2.xy * _AmbientOcclusion_ST.xy + _AmbientOcclusion_ST.zw;
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 uv_Metallic_Smoothness = packedInput.ase_texcoord3.xy * _Metallic_Smoothness_ST.xy + _Metallic_Smoothness_ST.zw;
				float4 tex2DNode12 = tex2D( _Metallic_Smoothness, uv_Metallic_Smoothness );
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_Metallic_Smoothness = packedInput.ase_texcoord7.xy * _Metallic_Smoothness_ST.xy + _Metallic_Smoothness_ST.zw;
				float4 tex2DNode12 = tex2D( _Metallic_Smoothness, uv_Metallic_Smoothness );
				
				float2 uv_AmbientOcclusion = packedInput.ase_texcoord7.xy * _AmbientOcclusion_ST.xy + _AmbientOcclusion_ST.zw;
...
Node;AmplifyShaderEditor.SamplerNode;14;-900.4413,661.6786;Inherit;True;Property;_AmbientOcclusion;Ambient Occlusion;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;37;4;12;0
WireConnection;37;7;36;0
WireConnection;37;8;14;0
ASEEND*/
//CHKSM=0942DB34BA5C21E75C1B467FD813A117DB3D53C3